...
public class RetailShopBillingSystem{
            ...
            while (true) {
                ...
                switch (choice) {
                    case 1:
                        ...
                        handleBillingMenu(connection);
                        break;
                    case 2:
                    	System.out.println("Enter BillId of the cutomer:");
                    	int billId = scanner.nextInt();
                    	System.out.println("Enter CustomerId of the cutomer:");
                    	int customerId =scanner.nextInt();
                         handlePaymentMethods(connection,billId,customerId);
                        break;
                    case 3:
                    	handleCustomerAndStockReports(connection);
                        break;
                    case 4:
...
//******************************************displayWelcomeMessage*********************************************************************
    public static void displayWelcomeMessage() {
    	System.out.println("---------------------------------------------------------");
        System.out.println("|                                                       |");
        System.out.println("|        Welcome to Tirunelveli's Premier Retail Shop   |");
        System.out.println("|               'Nellai Mart'                           |");
        System.out.println("|                                                       |");
        System.out.println("|  Your one-stop shop for all your grocery needs!       |");
        System.out.println("|  Located at: 123, Main Bazaar Street, Tirunelveli     |");
        System.out.println("|                                                       |");
        System.out.println("---------------------------------------------------------");
...
//*********************************************displayMainMenu************************************************************************
    public static void displayMainMenu() {
        ...
        System.out.println("   - Insert, delete, update, and display products.");
        System.out.println("2. Payment Methods and Feedback");
        System.out.println("   - Choose UPI, cash, or credit card payment.");
        System.out.println("   - Provide feedback.");
        System.out.println("3. Customer and Stock Reports");
        System.out.println("   - Generate detailed customer and stock analytical reports.");
